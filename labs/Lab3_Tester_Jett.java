...
public class Lab3_Tester_Jett {
  ...
  public void test8() {
    ...
    try {
      ...
      BufferedWriter file = new BufferedWriter(new FileWriter("valid1.txt"));
      file.write(expected);
      file.close();
    } catch (IOException err1) { }
    StringBuffer result = new StringBuffer("error");
    try{
      result = WordCounter.processFile("valid1.txt");
    } catch (Exception e) {}
  ...
  public void test9() {
    ...
    ByteArrayInputStream in = new ByteArrayInputStream("valid1.txt".getBytes());
    System.setIn(in);
    StringBuffer result = new StringBuffer("error");
    try{
      result = WordCounter.processFile("invalid1.txt");
    } catch (Exception e) {}
    assertEquals(expected, result.toString());
  ...
  public void test10() {
    ...
    try {
      String strCurrentLine = null;
      BufferedWriter file = new BufferedWriter(new FileWriter("empty1.txt"));
      String expected = "";
      file.write(expected);
      file.close();
    } catch (IOException err1) { }
    ...
    try {
      WordCounter.processFile("empty1.txt");
    } catch (EmptyFileException e){
      result = e.toString();
    } catch (Exception e){
      result = "error";
    }
    assertEquals("EmptyFileException: empty1.txt was empty", result);
  }
